...
public class HashTable01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(ht1.containsKey(3000));//true
		System.out.println(ht1.containsKey(3333));//false
		
		//contains() is the same with the containsValue() but prefer to use containsValue()
	   ...
	   Hashtable <String, Integer> ht2= new Hashtable<>();
		...
		System.out.println(ht1.equals(ht2));//ignores the order of the elements.
		                                    //It checks i)the number of entries ii)the entries
		
		
		//ht1.size()==0 and ht1.isEmpty() are same but ht1.isEmpty() is better to use
