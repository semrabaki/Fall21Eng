...
public class LinkedList01 {
	...
	public static void main(String[] args) {
     ...
     String firstElement1=ll1.element();//element () returns the first element without removing(it is coming fromList interface)(copy+paste)
     ...
     String firstElementll2=ll1.getFirst();//getFirst() returns the first element without removing (it is coming from queue interface)(copy+paste)
     System.out.println(firstElementll2);//Can
     System.out.println(ll1);//[Can, Mark, Tom]
     
     String firstElement3=ll1.peek();//the first element without removing(copy+paste)
...
//     String firstElFromEmptyLinkedList1= ll2.element();//element() method throws NoSuchElementException for the empty linked list
//     System.out.println(firstElFromEmptyLinkedList1);
     
     String firstElFromEmptyLinkedList2=ll2.peek();//peek() returns first element without removing and it returns 
                                                   //"null" for empty linked list
     System.out.println(firstElFromEmptyLinkedList2);
     
     String firstElFromEmptyLinkedList3=ll2.poll();//It returns"null" for empty linked llist
     System.out.println(firstElFromEmptyLinkedList3);
     
//     String firstElFromEmptyLinkedList4=ll2.getFirst();//getFirst() method throws NoSuchElementException for the empty linked list
//     System.out.println(firstElFromEmptyLinkedList4);
     ...
     Integer first1 = ll3.remove();//Returns:the head of this listThrows:NoSuchElementException - if this list is empty
